        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <p class="footer-desc">
                        Hệ thống bán lẻ công nghệ hàng đầu Việt Nam với hơn 100+ cửa hàng trên toàn quốc.
                    ...
                    <div class="social-links">
                        ...
                        <a href="#" class="social-link zalo" title="Zalo">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 14.894c-.553.553-1.447.553-2 0l-2-2c-.553-.553-.553-1.447 0-2s1.447-.553 2 0l2 2c.553.553.553 1.447 0 2zm-3.788-6.788c-.553-.553-.553-1.447 0-2s1.447-.553 2 0l2 2c.553.553.553 1.447 0 2s-1.447.553-2 0l-2-2z"/>
                            </svg>
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="contact-info">
                        <li>
                            ...
                            <span>
                                ...
                                123 Đường ABC, Hoàng Mai, Hà Nội
                            </span>
                        </li>
                        <li>
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 极简风格，注重实用性，追求极致的用户体验。
                            </svg>
                            <span>
        ...
        <div class="container">
            <div class="newsletter-content">
                <div class="newsletter-text">
                    ...
                    <p>Nhận ngay voucher 100.000đ cho đơn hàng đầu tiên!</p>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-content">
                <p class="copyright">
                    © <?php echo e(date('Y')); ?> <strong>FlashTech</strong>. All rights reserved. Made with
...
<?php /**PATH /home/flashtm/Documents/FlashTechMongo/resources/views/Customers/Layouts/Footer.blade.php ENDPATH**/ ?>