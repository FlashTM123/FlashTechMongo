        ...
        <div class="container">
            <div class="top-bar-content">
                ...
                <div class="top-right">
                            ...
                            <button class="top-link user-link" id="userDropdownBtn">
                                <div class="user-avatar">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($avatar): ?>
                                            <img src="<?php echo e($avatar); ?>" alt="<?php echo e(auth('customer')->user()->full_name); ?>">
                                    <?php else: ?>
                                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth('customer')->user()->full_name)); ?>&background=667eea&color=fff&size=64" alt="<?php echo e(auth('customer')->user()->full_name); ?>">
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                <span class="user-info">
                                    <span class="user-name"><?php echo e(auth('customer')->user()->full_name); ?></span>
                                </span>
                            ...
                            <div class="user-dropdown-menu" id="userDropdownMenu">
                                <div class="dropdown-header">
                                    <div class="dropdown-avatar">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth('customer')->user()->profile_picture_url): ?>
                                                <img src="<?php echo e(auth('customer')->user()->profile_picture_url); ?>"
                                                    alt="<?php echo e(auth('customer')->user()->full_name); ?>">
                                        <?php else: ?>
                                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth('customer')->user()->full_name)); ?>&background=667eea&color=fff&size=128"
                                                alt="<?php echo e(auth('customer')->user()->full_name); ?>">
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <div class="dropdown-user-info">
                                        <div class="dropdown-user-name"><?php echo e(auth('customer')->user()->full_name); ?></div>
                                        <div class="dropdown-user-email"><?php echo e(auth('customer')->user()->email); ?></div>
                                        <div class="dropdown-user-points">
                                            ...
                                            <span><?php echo e(auth('customer')->user()->loyalty_points ?? 0); ?> điểm</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown-divider"></div>
                                <a href="<?php echo e(route('customers.profile.detail')); ?>" class="dropdown-link">
                                ...
                                <a href="<?php echo e(route('customers.orders')); ?>" class="dropdown-link">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                        <path
                                ...
                                <a href="<?php echo e(route('wishlist.index')); ?>" class="dropdown-link">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2">
                                        <path
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('customers.login')); ?>" class="top-link login-link">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
                        ...
                        <span class="divider">|</span>
                        <a href="<?php echo e(route('customers.register')); ?>" class="top-link register-link">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2">
        ...
        <div class="container">
            <div class="nav-content">
                ...
                <div class="search-container">
                    <form action="<?php echo e(route('home')); ?>" method="GET" class="search-form" id="mainSearchForm">
                        ...
                        <input type="text" name="search" placeholder="Tìm kiếm sản phẩm, thương hiệu..."
                            class="search-input" value="<?php echo e(request('search')); ?>" autocomplete="off">
                ...
                <div class="nav-actions">
                    ...
                    ?>
                    <a href="<?php echo e(route('wishlist.index')); ?>" class="nav-action" title="Yêu thích">
                        ...
                        <span class="badge wishlist-count" style="<?php echo e($wishlistCount > 0 ? '' : 'display:none'); ?>"><?php echo e($wishlistCount); ?></span>
                    </a>
                    ...
                    ?>
                    <a href="<?php echo e(route('cart.index')); ?>" class="nav-action cart-action" title="Giỏ hàng">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                        ...
                        <span class="badge cart-count" style="<?php echo e($cartCount > 0 ? '' : 'display:none'); ?>"><?php echo e($cartCount); ?></span>
                    </a>
    ...
    <nav class="main-menu">
        <div class="container">
            <ul class="menu-list" id="mobileMenu">
                <li class="menu-item">
                    <a href="<?php echo e(route('home')); ?>" class="menu-link active">
                ...
                <li class="menu-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?php echo e(route('products.category', 'smartphone')); ?>" class="dropdown-item">📱
                            Smartphone</a>
                        <a href="<?php echo e(route('products.category', 'laptop')); ?>" class="dropdown-item">💻 Laptop</a>
                        <a href="<?php echo e(route('products.category', 'tablet')); ?>" class="dropdown-item">📲 Tablet</a>
                        <a href="<?php echo e(route('products.category', 'computer')); ?>" class="dropdown-item">🖥️ Computer</a>
                        <a href="<?php echo e(route('products.category', 'accessory')); ?>" class="dropdown-item">🎧 Phụ kiện</a>
                        <a href="<?php echo e(route('products.category', 'component')); ?>" class="dropdown-item">🛠️ Linh
                            kiện</a>
                    </div>
                </li>
                <li class="menu-item">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth('customer')->check()): ?>
                    <li class="menu-item only-mobile">
                        <a href="<?php echo e(route('customers.profile.detail')); ?>" class="menu-link">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <circle cx="12" cy="12" r="10"></circle>
                    ...
                    <li class="menu-item only-mobile">
                        <form action="<?php echo e(route('customers.logout')); ?>" method="POST" style="display:inline;">
                            <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <li class="menu-item only-mobile">
                        <a href="<?php echo e(route('customers.login')); ?>" class="menu-link">
                    ...
                    <li class="menu-item only-mobile">
                        <a href="<?php echo e(route('customers.register')); ?>" class="menu-link">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                                <circle cx="8.5" cy="7" r="4"></circle>
                                <polyline points="17 11 19 13 23 9"></polyline>
