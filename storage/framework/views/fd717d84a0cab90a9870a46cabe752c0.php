    ...
    <div id="notifications-panel" class="absolute top-full right-0 mt-2 w-80 sm:w-96 bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 hidden max-h-[400px] overflow-y-auto z-[1006]">
        <div class="p-4 border-b border-slate-100 sticky top-0 bg-white/90 backdrop-blur-sm z-10">
            <div class="flex justify-between items-center">
                <h3 class="font-semibold"><?php echo e(__('messages.notif.title')); ?></h3>
        ...
        <div id="notifications-list" class="divide-y">
            <div class="p-4 text-center text-gray-500">
                <?php echo e(__('messages.notif.no_notifications')); ?>

            </div>
        </div>

        <div class="p-4 border-t sticky bottom-0 bg-gray-50">
            <a href="<?php echo e(route('notifications.index')); ?>" class="btn btn-primary btn-sm w-full">
                <?php echo e(__('messages.common.view')); ?> <?php echo e(__('messages.notif.title')); ?>
...
function loadUnreadNotifications() {
    fetch('<?php echo e(route('notifications.getUnread')); ?>')
        ...
        .then(data => {
            ...
            if (data.notifications.length > 0) {
                ...
                list.innerHTML = '<div class="p-4 text-center text-gray-500"><?php echo e(__("messages.notif.no_notifications")); ?></div>';
            }
        });
}
...
document.addEventListener('DOMContentLoaded', function () {
    if (typeof window.Echo !== 'undefined') {
        const customerId = '<?php echo e(auth("customer")->id()); ?>';
        if (customerId) {
...
<?php /**PATH /home/flashtm/Documents/FlashTechMongo/resources/views/customers/components/notifications-widget.blade.php ENDPATH**/ ?>