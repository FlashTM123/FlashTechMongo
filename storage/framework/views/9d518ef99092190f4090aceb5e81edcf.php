        ...
        <div class="login-container">
            <div class="login-card">
                <div class="login-header">
                    ...
                    <h1>Đăng nhập</h1>
                    <p>Chưa có tài khoản? <a href="<?php echo e(route('customers.register')); ?>">Đăng ký ngay</a></p>
                </div>
                ...
                <form action="#" method="POST" class="login-form" id="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-input-wrapper">
                            ...
                            <input type="email" name="email" class="form-input" placeholder="example@email.com" value="<?php echo e(old('email')); ?>" required autofocus>
                        </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="social-login">
                        ...
                        <a href="<?php echo e(route('customers.login.google')); ?>" class="social-btn">
...
<?php /**PATH /home/flashtm/Documents/FlashTechMongo/resources/views/Customers/Account/login.blade.php ENDPATH**/ ?>