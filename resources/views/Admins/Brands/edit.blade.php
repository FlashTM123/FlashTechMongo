...
<div class="edit-brand-page">
    ...
    <div class="page-header">
        ...
        <div class="header-text">
            <div class="header-badge">✏️ CHỈNH SỬA</div>
            <h1>Chỉnh sửa thương hiệu</h1>
            <p>Cập nhật thông tin thương hiệu <strong>{{ $brand->name }}</strong></p>
        </div>
    </div>
        ...
        <form action="{{ route('brands.update', $brand->slug) }}" method="POST" enctype="multipart/form-data" class="edit-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="char-count">
                            <span id="charCount">{{ strlen($brand->description ?? '') }}</span>/500 ký tự
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <span class="label-text">Logo hiện tại</span>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <span class="label-text">{{ $brand->logo ? 'Tải lên Logo mới' : 'Tải lên Logo' }}</span>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="form-label">
                            <span class="label-text">Xem trước Logo mới</span>
                        </label>
                        <div class="logo-preview" id="logoPreview">
                            <div class="preview-empty">
                                ...
                                <p>Logo mới sẽ xuất hiện ở đây</p>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function confirmRemoveLogo() {
        if (confirm('Bạn có chắc chắn muốn xóa logo hiện tại?')) {
            ...
            alert('Logo sẽ được xóa khi bạn cập nhật thương hiệu');
        }
    }
</script>
