...
<div class="create-product-page">
    <div class="page-header">
        <div class="header-left">
            ...
            <p>Điền thông tin chi tiết sản phẩm bên dưới</p>
        </div>
    </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input" placeholder="VD: iPhone 15 Pro Max" required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="slug" name="slug" value="{{ old('slug') }}" class="form-input" placeholder="Tự động tạo từ tên sản phẩm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="sku" name="sku" value="{{ old('sku') }}" class="form-input" placeholder="VD: IP15PM-256GB-BLK" required>
                    @error('sku')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="color" name="color" value="{{ old('color') }}" class="form-input" placeholder="VD: Titan Đen, Trắng ngà, Xanh thiên thanh">
                    @error('color')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price') }}" class="form-input" placeholder="29990000" step="1000" required>
                        @error('price')
                        <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sale_price" name="sale_price" value="{{ old('sale_price') }}" class="form-input" placeholder="25990000" step="1000">
                        @error('sale_price')
                        <span class="error-message">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" class="form-input" min="0" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="6" class="form-textarea" placeholder="Nhập mô tả chi tiết về sản phẩm...">{{ old('description') }}</textarea>
                    <div class="char-counter">
                        <span id="desc-count">0</span>/1000 ký tự
                    </div>
                    @error('description')
                    <span class="error-message">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-section">
                ...
                <div id="specificationsContainer">
                    <!-- Specification items will be added here dynamically -->
                </div>
...
<script>
    ...
    mainImageArea.addEventListener('dragover', (e) => {
        e.preventDefault();
        mainImageArea.style.borderColor = 'var(--primary)';
        mainImageArea.style.background = 'rgba(102, 126, 234, 0.1)';
    });
